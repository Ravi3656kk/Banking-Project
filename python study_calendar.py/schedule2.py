...
# Add study events Mon–Sat and Sunday review for each month
for start_str, month_name, sessions in schedule:
    ...
    for day_offset in range(num_days):  # Loop through all days in the month
...
# Save the calendar file with utf-8 encoding
with open("StudySchedule.ics", "w", encoding="utf-8") as f:
    f.writelines(cal)

print("✅ Calendar generated successfully: StudySchedule.ics")
